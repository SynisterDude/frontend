        	...
        	<div class="panel panel-default">
				...
				<br>
			    		...
			    		<form method = "post" action="registerScript.php">
			    			...
			    			<a href="register.php"><b><font color="orange" align="center">Dont have an account?</font></b></a>
			    			<input type="submit" name="but_submit" value="Login Now"class="btn btn-warning btn-block">
